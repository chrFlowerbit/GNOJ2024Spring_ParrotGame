...
public class MeshDestroy : MonoBehaviour
{
    ...
    public float objectSize; // The size of the object, let's assume it's on one axis for simplicity
    public float minPartsCount = 1; // The minimum number of parts the object breaks into
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(MeshDestroy original)
        {
            ...
            collider.material = Resources.Load<PhysicMaterial>("Assets/Resources/Materials/PhysicsMaterials/NoFriction");
